...
2. Then, look for my code file called [prolog-simple-conifer-generator.pl](prolog-simple-conifer-generator/prolog-simple-conifer-generator.pl) and copy all of the code within it. Paste it into the left hand program window on the SWISH website. 
